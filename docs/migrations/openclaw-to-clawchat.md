# OpenClaw 到 ClawChat 迁移档案

> **版本**: 1.0
> **日期**: 2026-05-11
> **档案说明**: 本文保存从 OpenClaw/Ubuntu/Node/Gateway 迁移到 ClawChat/Alpine/Dart 直连工具架构的历史方案、删除清单和阶段记录。当前架构以仓库根目录 `ARCHITECTURE.md` 为准；当前视觉与交互规范以 `DESIGN.md` 为准。
